...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Blog articles for car accident medical center';
    displayName: 'Article';
    pluralName: 'articles';
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      ...
      'api::article.article'
    >;
    localKeywords: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiAuthorAuthor extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Medical professionals and content authors';
    displayName: 'Author';
    pluralName: 'authors';
    singularName: 'author';
  };
  ...
  attributes: {
    ...
    languages: Schema.Attribute.JSON &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<['en', 'es']>;
    locale: Schema.Attribute.String;
...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    color: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'#2C5AA0'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiFaqFaq extends Struct.CollectionTypeSchema {
  collectionName: 'faqs';
  info: {
    description: 'Frequently Asked Questions for SEO and user guidance';
    displayName: 'FAQ';
    pluralName: 'faqs';
    singularName: 'faq';
  };
  ...
  attributes: {
    ...
    category: Schema.Attribute.Enumeration<
      ['treatment', 'legal', 'insurance', 'appointment', 'billing']
    > &
      Schema.Attribute.DefaultTo<'treatment'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    featured: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
...
export interface ApiPhysicianPhysician extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Medical staff profiles for structured data and SEO';
  ...
  attributes: {
    ...
    licenseState: Schema.Attribute.String & Schema.Attribute.DefaultTo<'TX'>;
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Medical services for structured data and detailed SEO pages';
  ...
  attributes: {
    bodyLocation: Schema.Attribute.JSON;
    category: Schema.Attribute.Relation<'manyToOne', 'api::category.category'>;
    ...
    name: Schema.Attribute.String & Schema.Attribute.Required;
    order: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    physicians: Schema.Attribute.Relation<
      'manyToMany',
      'api::physician.physician'
    >;
    preparation: Schema.Attribute.Text;
    procedureType: Schema.Attribute.Enumeration<
      ['diagnostic', 'therapeutic', 'preventive', 'rehabilitation']
    > &
      Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    recovery: Schema.Attribute.Text;
...
export interface ApiTagTag extends Struct.CollectionTypeSchema {
  collectionName: 'tags';
  info: {
    description: 'Tags for organizing and categorizing articles';
    displayName: 'Tag';
    pluralName: 'tags';
    singularName: 'tag';
  };
